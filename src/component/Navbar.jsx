...
const Navbar = () => {
    ...
    return (
        <div className="bg-white relative">
            ...
            <div className={nav ? " translate-x-0 opacity-100 transition-all duration-500 fixed top-0 block lg:hidden" : " translate-x-[-100vw] opacity-0 transition-all duration-500 fixed top-0"}>
